...
function checkSuspects() {
    actualDay1.forEach(function(actualDay1Plate) {
        for(let plateCounter = 0; plateCounter < actualDay2.length; plateCounter++) {
            if(actualDay1Plate.toUpperCase() == actualDay2[plateCounter].toUpperCase()) {
                partial.push(actualDay1Plate);
            }
        }
    });

    partial.forEach(function(partialPlate) {
        for(let plateCounter = 0; plateCounter < actualDay3.length; plateCounter++) {
            if(partialPlate.toUpperCase() == actualDay3[plateCounter].toUpperCase()) {
